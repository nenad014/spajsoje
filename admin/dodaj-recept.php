            ...
            <div class="col-lg-12 col-md-12 py-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Dodaj recept</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <form action="add.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="name" placeholder="Naslov" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-2">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="body" id="textarea-input" rows="9" placeholder="Recept..." class="form-control" required></textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-2">
                                        <label for="file-input" class=" form-control-label">Slika</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                ...
                                <input type="submit" class="btn btn-primary" name="addRecipeBtn" value="Dodaj">
                        </form>
                    </div>
                </div>
            </div>
